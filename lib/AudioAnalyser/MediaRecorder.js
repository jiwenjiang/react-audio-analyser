    ...
    return function (_Target) {
        ...
        _createClass(MediaRecorderClass, [{
            ...
            value: function recordAudio(stream) {
                ...
                this.mediaRecorder = new MediaRecorder(stream, { audioBitsPerSecond: audioBitsPerSecond, mimeType: mimeType });
            ...
            value: function compatibility() {
                ...
                var promisifiedOldGUM = function promisifiedOldGUM(constraints) {
                    ...
                    if (!getUserMedia) {
                        MediaRecorderClass.checkAndExecFn(_this4.props.errorCallback);
